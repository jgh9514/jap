<%@page import="board_content.Board_Content_DAO"%>
...
<jsp:setProperty name="Bbs_data" property="bcode" value="1"/>
...
<%
	...
	int result = BbsDAO.Content_Insert(Bbs_data);
	...
	if(result == -1){
		...
		script.println("<script>");
		script.println("alert('글 등록이 완료되었습니다.')");
		script.println("location.href = 'read.jsp?board_no=" + board_no + "&bcode="+BbsDAO.count() + "'");
		script.println("</script>");
	}
%>